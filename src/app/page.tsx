  ...
  return (
    <main className={styles.main}>
      ...
      <MainPageGrid >
        ...
        <Card linkToPage="aboutMe"openInNewTab={false} text="Who am I?" image="/Muffin.jpg"  />
        <Card linkToPage="https://ko-fi.com/simplesample" openInNewTab text="Buy me a coffee!" image="/Coffee.jpg" />
        </MainContentGrid>
        </MainPageGrid>

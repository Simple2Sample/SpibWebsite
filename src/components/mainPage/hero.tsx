...
const Hero = () => {
    ...
    return(
    <StyledHero className="px-4 py-5 text-center">
    ...
    <HeroContainer className="col-lg-6 mx-auto">
      ...
      <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
        ...
        <a href="https://mlp.fandom.com/wiki/Spitfire"><StyledButton type="button" className="btn btn-outline-secondary btn-lg px-4">Who is Spitfire?</StyledButton></a>
      </div>
    </HeroContainer>
  </StyledHero>
  )
